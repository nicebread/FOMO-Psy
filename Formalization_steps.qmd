...
12. For the final report:
    1.  Copy the tables from the Google doc into the `/doc` subfolder of your repository, so that it is really self-contained (i.e., all relevant files are bundled in the project folder).
