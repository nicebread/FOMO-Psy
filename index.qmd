...
subtitle: "Winter term 2025/26, LMU Munich"
---

*Note: While most content is in English, some administrative parts are in German.*

This course is held in the 5th semester of the BSc. Psychology at the [Department Psychology, Ludwig-Maximilians-Universität München](https://lmu.de/psy).
...
Accordingly, we will deal a lot with the implementation in programming languages, mostly in R.

We will try to collaboratively formalise verbal psychological theories so that they can be translated and implemented in a data-generating model that allows to regenerate the phenomenon of interest. We will not run an empirical study and will not collect data.
