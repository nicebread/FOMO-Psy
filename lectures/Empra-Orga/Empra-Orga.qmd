---
title: "Formal modeling in psychology: Organizational Stuff"
...
- Learn skills and tools that aid theory development
  - Technical: Git, semantic versioning, make a theory pbject citeable...
  - Conceptual: 
...
Note: Github (where the website is hosted) is using chaching. 
