---
title: "Theory crisis: Jingle jangle jungle & non-robust phenomena"
author:
...
![](img/Wulff_JingleJangle_1.png){fig-align="center"}
...
![](img/Wulff_JingleJangle_2.png){fig-align="center"}
...
- The probably **most complex research object** in the known universe is investigated with...
  - ... ridiculously small samples and
  - ... imprecise methods.
:::
...
<!-- TODO: Move these last slides to another presentation? They are a bit an addendum here. -->
...
:::: {.columns}
::: {.column width='70%'}
Karl Popper once described science “**as the art of systematic over-simplification — the art of discerning what we may with advantage omit**”.
:::
