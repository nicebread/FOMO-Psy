...
- *Type* is one (or multiple) of: [P]{.hl}henomenon, [C]{.hl}oncept, [R]{.hl}elationship. Note: Sometimes a single quoted statement defines both a concept and a relationship.
