...
- Install and authorize the draw.io app in Github (only then access to private repositories is possible):
...
## Homework 2 (individually): Your first VAST displays
...
(B) **Draw** your first two VAST displays. **First**, draw the concept "diffusion of responsibility" with [draw.io](https://app.diagrams.net) (see concrete instructions below under "Deliverable"). You can either use the online version of draw.io, or download the desktop application.
...
**Second**, draw a smaller VAST display that depicts the *phenomenon* only (i.e., observable, generalizable patterns in data). This should only consist of observable variables. Hint: Phenomena typically are depicted as higher-order concepts.
...
For task 2B, save your draw.io VAST diagrams in our [Homework Repository]({{< var homework_repo >}}) by choosing "Github" as destination for your file:
...
*Additionally*, save the diagrams as a `.png` or `.jpg` file in the same folder (`homework/02-VAST/YOURNAME.png`). Use `Datei -> Exportieren als -> PNG/JPG` in draw.io to do so.
