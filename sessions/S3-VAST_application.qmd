...
- Create a Google Drive folder and add the Construct Table template.
...
- Each group makes a copy of the template file "Bystander Modell: Construct Table Template" that you find on Google Drive. Add your group name/letter to the file name!
...
- Step 4 ("Collect definitions of constructs"): Fill in the Construct Table 
...
- Complete and clean up your *Construct Table* on Google Drive (*not* yet the *Variables Table*).
