...
| ---------------------------------------------- | -------- | ---------------------------------------------------------- |
| Finalize VAST displays in groups               | 20       |                                                            |
...
- Create a *new* draw.io VAST display with the extended and reduced theory. Push the file to the homework repository in the folder `Dangerousness_effect`, in your group's subfolder.
- Create a copy of the Google doc with the Construct Source Table.