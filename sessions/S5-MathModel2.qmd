...
description: Create all functions for our Dangerous Bystander Effect Model
---

<!-- 25/26 run:
1. Modelle präsentieren
2. Abholen: Wir haben mit ChatGPT eine Funktion erstellen lassen -> neue Folie zeigen: Was ist der semantische Gehalt der drei Parameter?
...
| ---------------------------------------------------------------------------------- | -------- | -------------------------------------------------------- |
| Finalize models in groups; push to repo; present                                   | 50       |                                                          |
| Formalization: **Mathematical Models 2** (including group work to write functions) | 60       | [Slides](../lectures/MathModel/MathModel.qmd), Steps 2-3 |
| FGroup work "Apply everything to reduced model"                                    | 60       |                                                          |
| **[Homework]**: Learn `ggplot2`                                                    | -        |                                                          |
...
Although I use various code editors (e.g., Visual Studio Code, Positron), I currently recommend using RStudio because it has a deeply integrated support for building and testing Shiny apps.
