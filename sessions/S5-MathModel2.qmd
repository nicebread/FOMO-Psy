...
description: Create atomic functions for our Dangerous Bystander Effect Model
---


## Intermediate Feedback

Please give anonymous feedback here: [https://partici.fi/77082422](https://partici.fi/77082422)

![](img/particify/Zwischenevaluation.png){height=200px}
...
| Formalization: **Mathematical Models 2**         | 60       | [Slides](../lectures/MathModel/MathModel.qmd), Steps 2-3 |
| Group work "Apply everything to reduced model"   | 60       |                                                          |
