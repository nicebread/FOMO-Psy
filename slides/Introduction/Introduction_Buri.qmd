...
**{{< fa people-group size=2x >}} Question for discussion: Is "risky shift" a phenomenon?**
...
::: footer
Siehe [Wikipedia](https://de.wikipedia.org/wiki/Buridans_Esel)
:::
...
## [{{< fa people-group size=1x >}} Gruppenübung: Cover your ass, Level 1]{.r-fit-text}
...
- Fixe Geschwindigkeit *v* vom Esel
- Lineare Abnahme der Wasserreserve im Körper
- Lineare Abnahme der Futterreserve im Körper
- Die Futter- bzw. Wasseraufnahme dauert eine substantielle Zeit und findet in Schlucken statt (1 Einheit pro Zeiteinheit)
- Der Esel hat eine Repräsentation der Umwelt und weiß, wo die beiden Quellen sind.
