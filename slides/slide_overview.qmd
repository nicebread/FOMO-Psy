...
Here will be a listing of the slides.
...
files <- files[grep("slide_overview.qmd", files, invert = TRUE)]
...
knitr::kable(dplyr::arrange(lecture.list, desc(Date)), escape = FALSE) %>%
